package com.phoebus.pandemic.test.teste_phoebus.resources.config;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.phoebus.pandemic.test.teste_phoebus.resources"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                "API teste phoebus",
                "Esta API é utilizada para o teste da empresa phoebus",
                "Versão 1.0",
                "",
